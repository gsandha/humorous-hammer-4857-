    ...
    <div style={{backgroundColor:"#f2f4f5",height:"100vh"} }>
     <Flex>
        ...
        <TabPanels>
          <TabPanel>
            ...
            navigate("/")  
                ...
                Securely Pay {carts.length===0?0:sum+99}₹
              </Button>
            </Box>
          </TabPanel>
          <TabPanel>
      ...
      <Box w="30%">
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}> <Text pt="10px">Total Discounts</Text> <Text pt="10px" color="green">₹</Text></div> 
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>    <Text pt="10px">Shipping Charges</Text> <Text pt="10px">{carts.length===0?0:99}₹</Text></div> 
          ...
          <hr/>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}><Text fontWeight="bold">Payable Amount</Text> <Text pt="10px" fontWeight="bold">{carts.length===0?0:sum+99}₹ </Text></div> 
        <Text color="green" fontSize="13px">
        You will Save ₹ & Earn ₹51 Vigor Cash on this order
            </Text>   
        </Box>
      </Box>
    </Flex>
